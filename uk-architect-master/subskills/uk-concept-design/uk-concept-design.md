---
name: uk-concept-design
description: >
  Optioneering, stage strategy, concept options, or value/cost/risk balancing at early design. Use when the user asks about topics in this module scope for UK architectural practice.
...
|---------------|------------|-------------|
| Technical packages | `uk-concept-design` | `uk-construction-documentation` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: Optioneering, stage strategy, concept options, or value/cost/risk balancing at early design
