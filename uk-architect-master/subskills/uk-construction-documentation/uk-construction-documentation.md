---
name: uk-construction-documentation
description: >
  Technical packages, NBS-aligned specs, drawing quality, or stage-4 coordination. Use when the user asks about topics in this module scope for UK architectural practice.
disable-model-invocation: true
user-invocable: true
---

# UK Construction Documentation

## When to Use This Skill

| Question type | This skill | Use instead |
|---------------|------------|-------------|
| Building Control strategy | `uk-construction-documentation` | `uk-building-codes` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: Technical packages, NBS-aligned specs, drawing quality, or stage-4 coordination
