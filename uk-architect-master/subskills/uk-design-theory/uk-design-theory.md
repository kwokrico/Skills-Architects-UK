---
name: uk-design-theory
description: >
  Design rationale, architectural theory, or design critique beyond compliance. Use when the user asks about topics in this module scope for UK architectural practice.
...
|---------------|------------|-------------|
| Statutory compliance | `uk-design-theory` | `uk-building-codes` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: Design rationale, architectural theory, or design critique beyond compliance
