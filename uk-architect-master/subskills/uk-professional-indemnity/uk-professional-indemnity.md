---
name: uk-professional-indemnity
description: >
  PI insurance, claim notification, liability exposure, or risk transfer in appointments. Use when the user asks about topics in this module scope for UK architectural practice.
...
|---------------|------------|-------------|
| Contract liability | `uk-professional-indemnity` | `uk-tender-contract-administration` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: PI insurance, claim notification, liability exposure, or risk transfer in appointments
