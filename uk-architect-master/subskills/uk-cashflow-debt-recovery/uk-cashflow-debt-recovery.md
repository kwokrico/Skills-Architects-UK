---
name: uk-cashflow-debt-recovery
description: >
  Practice cashflow, debt recovery, payment cycles, or fee collection risk. Use when the user asks about topics in this module scope for UK architectural practice.
disable-model-invocation: true
user-invocable: true
---

# UK Cashflow and Debt Recovery

## When to Use This Skill

| Question type | This skill | Use instead |
|---------------|------------|-------------|
| Fee proposal | `uk-cashflow-debt-recovery` | `uk-fee-proposal-strategy` |
| Contract payment | `uk-cashflow-debt-recovery` | `uk-tender-contract-administration` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: Practice cashflow, debt recovery, payment cycles, or fee collection risk
