---
name: uk-daylighting-design
description: >
  Daylight factor, sunlight amenity, right to light risk, or daylight/sunlight studies. Use when the user asks about topics in this module scope for UK architectural practice.
disable-model-invocation: true
user-invocable: true
---

# UK Daylighting Design

## When to Use This Skill

| Question type | This skill | Use instead |
|---------------|------------|-------------|
| Planning sunlight/daylight | `uk-daylighting-design` | `uk-spatial-planning` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: Daylight factor, sunlight amenity, right to light risk, or daylight/sunlight studies
