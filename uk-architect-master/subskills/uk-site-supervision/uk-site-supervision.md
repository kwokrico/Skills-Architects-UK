---
name: uk-site-supervision
description: >
  Site inspections, NCRs, RFIs, quality governance, or construction stage administration. Use when the user asks about topics in this module scope for UK architectural practice.
...
|---------------|------------|-------------|
| Contract variations | `uk-site-supervision` | `uk-tender-contract-administration` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: Site inspections, NCRs, RFIs, quality governance, or construction stage administration
