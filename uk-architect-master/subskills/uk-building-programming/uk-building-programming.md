---
name: uk-building-programming
description: >
  Schedule of accommodation, briefing, utilisation, test-fits, or space standards. Use when the user asks about topics in this module scope for UK architectural practice.
disable-model-invocation: true
user-invocable: true
---

# UK Building Programming

## When to Use This Skill

| Question type | This skill | Use instead |
|---------------|------------|-------------|
| Planning use class | `uk-building-programming` | `uk-spatial-planning` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: Schedule of accommodation, briefing, utilisation, test-fits, or space standards
