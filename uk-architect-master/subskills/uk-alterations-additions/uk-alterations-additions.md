---
name: uk-alterations-additions
description: >
  Refurbishment, extension, change of use interfaces, or existing-building adaptation strategy. Use when the user asks about topics in this module scope for UK architectural practice.
disable-model-invocation: true
user-invocable: true
---

# UK Alterations and Additions

## When to Use This Skill

| Question type | This skill | Use instead |
|---------------|------------|-------------|
| PD small works | `uk-alterations-additions` | `uk-minor-works` |
| Unlawful works | `uk-alterations-additions` | `uk-unauthorised-building-works` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: Refurbishment, extension, change of use interfaces, or existing-building adaptation strategy
