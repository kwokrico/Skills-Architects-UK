---
name: uk-project-resource-levelling
description: >
  Resource planning, team levelling, workload peaks, or delivery capacity. Use when the user asks about topics in this module scope for UK architectural practice.
disable-model-invocation: true
user-invocable: true
---

# UK Project Resource Levelling

## When to Use This Skill

| Question type | This skill | Use instead |
|---------------|------------|-------------|
| Fee/cashflow | `uk-project-resource-levelling` | `uk-fee-proposal-strategy` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: Resource planning, team levelling, workload peaks, or delivery capacity
