---
name: uk-structural-systems
description: >
  Structural strategy, buildability, movement joints, or structural coordination. Use when the user asks about topics in this module scope for UK architectural practice.
...
|---------------|------------|-------------|
| Building Regs coordination | `uk-structural-systems` | `uk-building-codes` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: Structural strategy, buildability, movement joints, or structural coordination
