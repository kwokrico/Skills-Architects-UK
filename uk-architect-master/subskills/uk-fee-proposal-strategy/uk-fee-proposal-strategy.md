---
name: uk-fee-proposal-strategy
description: >
  Fee proposals, scope of services, appointment terms, or commercial positioning. Use when the user asks about topics in this module scope for UK architectural practice.
disable-model-invocation: true
user-invocable: true
---

# UK Fee Proposal Strategy

## When to Use This Skill

| Question type | This skill | Use instead |
|---------------|------------|-------------|
| Contract admin | `uk-fee-proposal-strategy` | `uk-tender-contract-administration` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: Fee proposals, scope of services, appointment terms, or commercial positioning
