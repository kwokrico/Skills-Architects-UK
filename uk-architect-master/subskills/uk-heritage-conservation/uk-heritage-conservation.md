---
name: uk-heritage-conservation
description: >
  Listed buildings, conservation areas, heritage impact, or HIA-style assessments. Use when the user asks about topics in this module scope for UK architectural practice.
...
|---------------|------------|-------------|
| Planning application | `uk-heritage-conservation` | `uk-spatial-planning` |
| PD rights | `uk-heritage-conservation` | `uk-minor-works` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: Listed buildings, conservation areas, heritage impact, or HIA-style assessments
...
* [hia-starter-checklist.md](../../references/checklists/hia-starter-checklist.md) — module checklist
