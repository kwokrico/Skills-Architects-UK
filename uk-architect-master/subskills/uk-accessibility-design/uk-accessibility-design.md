---
name: uk-accessibility-design
description: >
  Part M, inclusive design, approach routes, vertical circulation, sanitary provision, or accessibility strategy. Use when the user asks about topics in this module scope for UK architectural practice.
...
|---------------|------------|-------------|
| Building Regulations general routing | `uk-accessibility-design` | `uk-building-codes` |
| Planning merit only | `uk-accessibility-design` | `uk-spatial-planning` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: Part M, inclusive design, approach routes, vertical circulation, sanitary provision, or accessibility strategy
