---
name: uk-building-envelope
description: >
  Facade, thermal bridges, moisture risk, weathertightness, or envelope coordination. Use when the user asks about topics in this module scope for UK architectural practice.
...
|---------------|------------|-------------|
| Part L/O strategy | `uk-building-envelope` | `uk-building-sustainability` |
| Fire facade strategy | `uk-building-envelope` | `uk-fire-life-safety` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: Facade, thermal bridges, moisture risk, weathertightness, or envelope coordination
