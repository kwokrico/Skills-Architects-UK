---
name: uk-lease-compliance
description: >
  Lease constraints, landlord approvals, reinstatement, or tenant alteration obligations. Use when the user asks about topics in this module scope for UK architectural practice.
...
|---------------|------------|-------------|
| Contract law | `uk-lease-compliance` | `uk-tender-contract-administration` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: Lease constraints, landlord approvals, reinstatement, or tenant alteration obligations
