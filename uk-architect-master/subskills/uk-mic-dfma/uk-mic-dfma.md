...
name: uk-mic-dfma
description: >
  Modern methods of construction, offsite, modular, or DfMA delivery strategy. Use when the user asks about topics in this module scope for UK architectural practice.
...
|---------------|------------|-------------|
| Site quality | `uk-mic-dfma` | `uk-site-supervision` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: Modern methods of construction, offsite, modular, or DfMA delivery strategy
