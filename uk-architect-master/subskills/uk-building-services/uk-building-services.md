---
name: uk-building-services
description: >
  MEP strategy, plant distribution, commissioning planning, or services coordination. Use when the user asks about topics in this module scope for UK architectural practice.
...
|---------------|------------|-------------|
| Part L carbon strategy | `uk-building-services` | `uk-building-sustainability` |

## Execution protocol

1. Confirm project context per master intake checklist (`../../references/operational.md`).
2. Apply module scope: MEP strategy, plant distribution, commissioning planning, or services coordination
